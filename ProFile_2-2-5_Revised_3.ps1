...
function checkIndex() { <# Checks to see if an index is already created and returns a boolean value. #> if (test-path $file.indexFile){return $true}else{return $false}}
