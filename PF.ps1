<#
    ProFile - Ver: 2.2.6
    Copyright (c) 2023 - Caffeinated Software Systems - All Rights Reserved
    Coded by: CoffeeIsCode
    Updated: Dec,15,2024    
#>
...
function help() {
    ...
    "[ ] - Removed duplicate functions from upgrade. "
    "[ ] - "
    "[ ] - "
    "[ ] - "
    "[ ] - "
...
### DEV MODE ###
$app.devMode = $false; # Resets Network and updates programs to fix issues. 
...
$index.checked = $false; $index.exists = checkIndex;
...
function program-updates() {
    ...
    $program.update = @{ powershell = winget update powershell };
    # $program.update = winget update;
    $count = $program.update.count;
    $updates = $program.update[$count - 1];
    $program.pending = "There are $updates";
...
### GLOBALS ###
$app = @{};
$app.devMode = $false; $app.debugMode = $false;
$app.title = "ProFile";
$app.
$app.status = "Starting";
